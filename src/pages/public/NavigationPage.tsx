...
export default function NavigationPage() {
  ...
  return (
    <div className="relative">
      ...
      {/* ---- 3D companion ------------------------------------------- */}
      {/* scroll-mt clears the 74px sticky navbar, or the jump lands with the card's own
          heading hidden behind it. */}
      <PageSection tone="white" width="wide" id={THREE_D_SECTION_ID} className="scroll-mt-24">
        <ThreeDNavigatorCard />
      </PageSection>
