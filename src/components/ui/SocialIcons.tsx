...
/** X, formerly Twitter. The wordmark is a glyph now, so this is the glyph. */
export function XIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M17.53 3h3.1l-6.77 7.74L21.8 21h-6.2l-4.86-6.35L5.18 21H2.07l7.24-8.28L2.2 3h6.36l4.39 5.8L17.53 3zm-1.09 16.13h1.72L7.64 4.78H5.8l10.64 14.35z" />
    </svg>
  );
}
